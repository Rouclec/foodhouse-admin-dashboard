...
type Querier interface {
	...
	ListAgentAvailableOrders(ctx context.Context, arg ListAgentAvailableOrdersParams) ([]ListAgentAvailableOrdersRow, error)
	ListAgentDeliveredOrders(ctx context.Context, arg ListAgentDeliveredOrdersParams) ([]ListAgentDeliveredOrdersRow, error)
	ListAgentOngoingOrders(ctx context.Context, arg ListAgentOngoingOrdersParams) ([]ListAgentOngoingOrdersRow, error)
