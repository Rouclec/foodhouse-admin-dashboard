      ...
      <ScrollView style={defaultStyles.scrollContainer}>
        <View style={profileFlowStyles.innerContainer}>
          ...
          <TouchableOpacity style={profileFlowStyles.row} onPress={handleEmailPress}>
            ...
            <Text style={profileFlowStyles.navigationText}>{email || 'support@foodhouse.com'}</Text>
          </TouchableOpacity>

          <TouchableOpacity style={profileFlowStyles.row} onPress={handlePhonePress}>
            <View style={profileFlowStyles.iconContainer}>
              <Ionicons name="call" size={20} color={Colors.primary[500]} />
            </View>
            <Text style={profileFlowStyles.navigationText}>{phoneNumber || '+1 (555) 123-4567'}</Text>
          </TouchableOpacity>

          <TouchableOpacity style={profileFlowStyles.row} onPress={handleWhatsAppPress}>
            <View style={profileFlowStyles.iconContainer}>
              <FontAwesome name="whatsapp" size={20} color={Colors.primary[500]} />
            </View>
            <Text style={profileFlowStyles.navigationText}>{i18n.t("(farmer).(profile-flow).(settings).chat")}</Text>
          </TouchableOpacity>
