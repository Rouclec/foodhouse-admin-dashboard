...
import { Search, Flag, UserX, Leaf, MessageCircle } from "lucide-react"
                ...
                <TableRow key={farmer.id}>
                  <TableCell>
                    <div>
                      ...
                      <div className="md:hidden mt-1 text-xs text-gray-500">{farmer.farmName}</div>
                    </div>
                  </TableCell>
                  <TableCell className="hidden md:table-cell font-medium">{farmer.farmName}</TableCell>
                  <TableCell className="hidden lg:table-cell">{farmer.location}</TableCell>
                  <TableCell className="hidden lg:table-cell">{farmer.totalProducts} products</TableCell>
                  <TableCell>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end space-x-2">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => handleFlagFarmer(farmer.id)}
                        title={farmer.status === "flagged" ? "Remove flag" : "Flag farmer"}
                      >
