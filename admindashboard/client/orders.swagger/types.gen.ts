...
export type OrdersApproveOrderBody = {
...
export type ordersgrpcGetAvailablePaymentMethodsResponse = {
  availableMethods?: Array<ordersgrpcPaymentMethodType>;
};
...
export type OrdersGetAvailablePaymentMethodsData = {
  query?: {
    userId?: string;
  };
};

export type OrdersGetAvailablePaymentMethodsResponse =
  ordersgrpcGetAvailablePaymentMethodsResponse;

export type OrdersGetAvailablePaymentMethodsError = rpcStatus;
